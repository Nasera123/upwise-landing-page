...
* Routing menggunakan route GET untuk menampilkan landing page.
* Controller optional. Bisa pakai route closure.
* Blade template untuk halaman landing.
* File APK disimpan di storage public atau folder public.
* Jika memakai storage, buat symbolic link `php artisan storage:link`.
